...
const AdminDashboard = () => {
    const state = {
        series: [
            {
                name: 'Orders',
                data: [22,22,22,45,67,64,25,90]
            },
            {
                name: 'Revenue',
                data: [22,43,56,45,67,64,25,33]
            },
            {
                name: 'Sellers',
                data: [98,52,43,45,67,45,25,90]
            }
        ],
        options: {
            color: ["#181ee8", "#181ee8"],
            ...
            xaxis: {
                categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Des']
            },
            legend: {
                position: 'top'
            },
    ...
    return ( 
        <div className="px-2 md:px-7 py-5">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
                <div className="flex justify-between items-center p-5 bg-blue-900 rounded-md gap-3">
            ...
            <div className="w-full flex flex-wrap mt-7">
                <div className="w-full lg:w-7/12 lg:pr-3">
                    <div className="w-full bg-blue-900 p-4 rounded-md">
                         <Chart options={state.options} series={state.series} type="bar" height={350}/>
                    </div>
                </div>
                <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
                    <div className="w-full bg-blue-900 p-4 rounded-md text-[d0d2d6]">
                            ...
                            <ol className="relative border-1 border-slate-600 ml-4"> 
                                <li className="mb-3 ml-6">
                                    ...
                                    <div className="p-3 bg-blue-700 rounded-lg shadow-sm"> 
                                        ...
                                        <div className="p-2 text-xs font-normal bg-blue-900 rounded-lg">
                                            How are you?
                                        </div>
                                    </div>
                                </li>
            ...
            <div className="w-full p-4 bg-blue-900 rounded-md mt-6">
                <div className="flex justify-between items-center">
                        ...
                        <tbody>
                            {
                                ...
                                <td scope="col" className="py-3 px-4 font-medium whitespace-nowrap">#455fdf54545</td>
                                <td scope="col" className="py-3 px-4 font-medium whitespace-nowrap">$675</td>
