...
import { getSeller, sellerStatusUpdate, messageClear } from '../../store/Reducers/sellerReducer'
            ...
            <div className="w-full p-4 bg-[#283046] rounded-md">
                <div className='w-full flex flex-wrap text-[#d0d2d6]'>
                    <div className='w-3/12 flex justify-center items-center py-3'>
                        <div>
                            {
                                seller?.image ? <img className='w-full h-[230px]' src="http://localhost:3000/images/duck.jpg" alt="" /> : <span>Image not uploaded</span>
                            }
                        </div>
                    </div>
