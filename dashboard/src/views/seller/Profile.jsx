    ...
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full flex flex-wrap">
        <div className="w-full md:w-6/12">
          <div className="w-full bg-[#283046] rounded-md text-[#d0d2d6]">
            ...
            <div className="px-0 md:px-5 py-2">
              <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative">
                ...
                <div className="flex gap-2">
                  <span>Email : </span>
                  <span>emilylaura@gmail.com</span>
                </div>
                <div className="flex gap-2">
                  <span>Role : </span>
                  <span>seller</span>
          ...
          <div className="w-full pl-0 md:pl-7 mt-6 md:mt-0 ">
            <div className="bg-[#283046] rounded-md text-[#d0d2d6] p-4">
              ...
              <form>
                ...
                <button className="bg-blue-500 hover:shadow-blue-500/50 hover:shadow-lg hover:text-white rounded-md px-7 py-2 mt-5">
                  Submit
                </button>
              </form>
            </div>
