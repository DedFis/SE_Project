        ...
        <div className="flex w-full h-full relative">
            ...
            <div className="w-full h-[calc(100vh-177px)] bg-[#252b3b] md:bg-transparent overflow-y-auto">
              ...
              >
                <div className="relative">
                  <img
                    className="w-[38px] h-[38px] border-white border-2 max-w-[42px] p-[2px] rounded-full"
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
              ...
              <div className="bg-slate-800 h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto">
                <div className="w-full flex justify-start items-center">
                  <div className="flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]">
                    <div>
                      <img
                        className="w-[38px] h-[38px] border-2 border-white max-w-[38px] p-[3px] rounded-full"
                        src="http://localhost:3000/images/duck.jpg"
                        alt=""
                      />
                    </div>
            ...
            <form className="flex gap-3">
              ...
              />
              <button className="bg-cyan-500 shadow-lg hover:shadow-cyan-500/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center">
                Send
              </button>
            </form>
          </div>
