    ...
    return (
      <div style={style} className="flex text-sm">
        ...
        <div className="w-[25%] p-2 whitespace-nowrap">
          <span className="pb-[5px] py-[1px] px-[5px] bg-slate-700 text-blue-500 rounded-md text-xs">
            pending
          </span>
        </div>
  ...
  return (
    <div className="px-2 md:px-7 py-5">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-5 ">
        <div className="flex justify-between items-center p-5 bg-blue-900 rounded-md gap-3 shadow-lg">
            ...
            <form>
              <div className="flex gap-3 flex-wrap">
                <input
                  ...
                  name="amount"
                />
                <button className="bg-indigo-500 hover:shadow-indigo-500 hover:shadow-lg text-white rounded-sm px-4 py-2 text-sm">
                  Submit
                </button>
              </div>
            </form>
