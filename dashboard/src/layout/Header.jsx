...
const Header = ({showSidebar, setShowSidebar}) => {
    ...
    return ( 
        <div className="fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40">
            <div className="ml-0 lg:ml-[250px] rounded-md h-[65px] flex justify-between items-center bg-blue-900 text-[#d0d2d6] px-5 transition-all">
                    ...
                    <div className='flex justify-center items-center'>
                        <div className='flex justify-center items-center gap-3'>
                            <div className='flex justify-center items-center flex-col text-end'>
                                <h2 className='text-sm font-bold'>Madeline Emily</h2>
                                <span className='text-[14px] w-full font-normal'>Admin</span>
                            </div>
                            <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src="http://localhost:3000/images/duck.jpg" alt="" />
                        </div>
                    </div>
