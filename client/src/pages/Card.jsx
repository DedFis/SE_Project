...
const Card = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("http://localhost:3000/images/banner/2.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                                    ...
                                    <div className='flex flex-col gap-3'>
                                        ...
                                        </div>
                                        {
                                            card_products.map((p, i) => <div className='flex bg-white p-4 flex-col gap-2'>
                                                <div className='flex justify-start items-center'>
                                                    <h2 className='text-md text-slate-600'>Madeline's Store</h2>
                                                </div>
                                                {
                                                    [1,2].map((pt, i) => <div className='w-full flex flex-wrap'>
                                                        <div className='flex sm:w-full gap-2 w-7/12'>
                                                            <div className='flex gap-2 justify-start items-center'>
                                                                <img className='w-[80px] h-[80px]' src={`http://localhost:3000/images/product/2.jpg`} alt="product image" />
                                                                <div className='pr-4 text-slate-600'>
                                                                    <h2 className='text-md'>Tes</h2>
                                                                    <span className='text-sm'>Brand : Tes</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                            <div className='pl-4 sm:pl-0'>
                                                                <h2 className='text-lg text-orange-500'>$23</h2>
                                                                <p className='line-through'>Gratis</p>
                                                                <p>-2%</p>
                                                            </div>
                                        ...
                                        }
                                        {
                                            outOfStockProduct.length > 0 && <div className='flex flex-col gap-3'>
                                                ...
                                                <div className='bg-white p-4'>
                                                    {
                                                        outOfStockProduct.map((p, i) => <div key={i} className='w-full flex flex-wrap'>
                                                            <div className='flex sm:w-full gap-2 w-7/12'>
                                                                <div className='flex gap-2 justify-start items-center'>
                                                                    <img className='w-[80px] h-[80px]' src={`http://localhost:3000/images/product/3.jpg`} alt="product image" />
                                                                    <div className='pr-4 text-slate-600'>
                                                                        <h2 className='text-md'>Udang</h2>
                                                                        <span className='text-sm'>Brand : Srimp</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
