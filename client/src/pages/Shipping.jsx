                                ...
                                </div>
                                {
                                    [1,2].map((p, i) => <div key={i} className='flex bg-white p-4 flex-col gap-2'>
                                        <div className='flex justify-start items-center'>
                                            <h2 className='text-md text-slate-600'>Madeline Shop</h2>
                                        </div>
                                        {
                                            [1,2].map((pt, j) => <div className='w-full flex flex-wrap'>
                                                <div className='flex sm:w-full gap-2 w-7/12'>
                                                    <div className='flex gap-2 justify-start items-center'>
                                                        <img className='w-[80px] h-[80px]' src={`http://localhost:3000/images/product/${pt}.jpg`} alt="product image" />
                                                        <div className='pr-4 text-slate-600'>
                                                            <h2 className='text-md'>Ikan</h2>
                                                            <span className='text-sm'>Brand : Masako</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className='flex justify-end w-5/12 sm:w-full sm:mt-3'>
                                                    <div className='pl-4 sm:pl-0'>
                                                        <h2 className='text-lg text-orange-500'>$22</h2>
                                                        <p className='line-through'>$34</p>
                                                        <p>-3%</p>
                                                    </div>
                                                </div>
                                            </div>)
