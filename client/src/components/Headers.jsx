                ...
                <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                  <li>
                    <Link
                      to="/"
                      className={`p-2 block ${
                        pathname === "/" ? "text-[#46c6c7]" : "text-slate-600"
                      }`}
                    >
                      Home
                    </Link>
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              <div
                ...
                className="h-[50px] bg-[#46c6c7] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
              >
            ...
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
              <div className="w-8/12 md-lg:w-full">
                <div className="flex border h-[50px] items-center relative gap-5">
                  ...
                  <button
                    onClick={search}
                    className="bg-[#46c6c7] right-0 absolute px-8 h-full font-semibold uppercase text-white"
                  >
                    Search
                  </button>
                </div>
